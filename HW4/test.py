...
# Parameters
# p  = FFFFFFFF FFFFFFFF FFFFFFFF FFFFFFFF 7FFFFFFF, p % 4 == 3
...
class Point:
    ...
    def point_doubling(self):
        ...
        result.y = (p - self.y + lamb * ((self.x - result.x) % p)) % p
        #de_str, nu_str, la_str, x_str, y_str = format(denominator, 'x').upper(), format(numerator, 'x').upper(), format(lamb, 'x').upper(), format(result.x, 'x').upper(), format(result.y, 'x').upper()
        #print(f'de = {de_str}')
        #print(f'nu = {nu_str}')
        #print(f'la = {la_str}')
        #print(f'x = {x_str}')
...
def find_point(P_x, a, b, p):
    ...
    if select == 2 and r % 2 == 0:
        P_y = r
    elif select == 2 and r % 2 == 1:
        P_y = p - r
    elif select == 3 and r % 2 == 0:
        P_y = p - r
    elif select == 3 and r % 2 == 1:
        P_y = r
...
def show_encryption():
    ...
    M_str = ['110BA66CC954BE963A7831D9D9A3D1D39B8EC3',
             '8E6F2C1DC3987AFECCC6F7DDFF75EDFC324DF6',     '668E9E1D01A306A1AB76C9949A973248E3AB53']
    Pa_x_str = ['027AB13D6D69847A9CCE9A84E5DB1BDDD87F11F38C',
                '039994C5C16070EE878F89A6143CE865AC2EC7EC5D', '027AB13D6D69847A9CCE9A84E5DB1BDDD87F11F38C']
    nk_str = ['8E07EB4265F1200D0745BCB3E47EDD2D23FBF571',
              '5487CF3D6F9E4F1C3DAEF5C3CF7D6FC33C675DC6',   '8E07EB4265F1200D0745BCB3E47ADD2D23FBF573']
...
def show_decryption():
    ...
    Pk_str = ['023D5A5C8A80799494624E741A0119804FF707A2AB',
              '03EFE1AC151C68EDAF3AA85E8D5589FCE27D4C405B', '03BDC5D14A5BA16F6787A050C6CD2F4C4C72AD2671']
    Pb_str = ['023C83F7C52185D5ACBE56171880995F591DFE5C3C',
              '038970C8F5C2BB301E5EC4D31DDB22524294FDACED', '02A9FC4BBA3F7B3D53D3CEF8D0D9F0165882541CE2']
    na_str = ['3C870C3E99245E0D1C06B747DEB3124DC843BB8B',
              '3C870C3E99245E0D1C06B747DEB3124DC843BB8B',   '246FF426810C46F504EE9F2FC69BFA35B02BA373']
    for i in range(0, len(Pk_str)):
        ...
        # choose Pk_y through find_point() process
        Pk = find_point(Pk, a, b, p)
        # choose Pb_y through find_point() process
        Pb = find_point(Pb, a, b, p)
